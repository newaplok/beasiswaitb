<form method="post" action="registrasi">
	...
	<tr>
	    <td><a>nim tpb</a></td>
	    <td><a><input type="text" name="reg_nim_tpb"></a></td>
	</tr>
	<tr>
	    <td><a>nim jurusan</a></td>
	    <td><a><input type="text" name="reg_nim_jur"></a></td>
	</tr>
	<tr>
	    <td><a>email_itb</a></td>
	    <td><a><input type="text" name="reg_email_itb"></a></td>
	</tr>
	<tr>
	    <td><a>password</a></td>
	    <td><a><input type="password" name="reg_password"></a></td>
	</tr>
	<tr>
	    <td><a>confirm password</a></td>
	    <td><a><input type="password" name="reg_confirm_password"></a></td>
	</tr>
	<tr>
	    <td><a></a></td>
	    <td><a><input type="submit" name="submit" value="daftar"></a></td>
	</tr>
    </table>
